...
namespace Ticari_Otomasyon
{
    public partial class FrmMusteriler : Form
    {
        ...
        private void btnkaydet_Click(object sender, EventArgs e)
        {
            ...
            bgl.baglanti().Close();
            MessageBox.Show("Müşteri Kayıt Edildi", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            listele();
            temizle();
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.Yes)
            {
                ...
                komut.Parameters.AddWithValue("@p1", txctid.Text);               //delete row from database or datagridview...
                komut.ExecuteNonQuery();
                bgl.baglanti().Close();
                MessageBox.Show("Silme işlemi gerçekleşti", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                listele();
            }
        ...
        private void simpleButton2_Click(object sender, EventArgs e)
        {
            ...
            komut.Parameters.AddWithValue("@p11", txctid.Text);
            komut.ExecuteNonQuery();
            bgl.baglanti().Close();
